# Script d'exécution pour l'exercice 11
# Climatologie urbaine (profils saisonniers)

Write-Host "=== EXERCICE 11: CLIMATOLOGIE URBAINE (PROFILS SAISONNIERS) ===" -ForegroundColor Green
Write-Host "Regroupement des données historiques par mois pour créer des profils saisonniers" -ForegroundColor Cyan
...
Write-Host "Profils saisonniers créés dans HDFS:" -ForegroundColor Cyan
hdfs dfs -ls /hdfs-data/France/Paris/seasonal_profile/

Write-Host "`n=== EXERCICE 11 TERMINE ===" -ForegroundColor Green
