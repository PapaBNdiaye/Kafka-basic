# Script d'exécution pour l'exercice 10
# Détection des records climatiques locaux

Write-Host "=== EXERCICE 10: DETECTION DES RECORDS CLIMATIQUES LOCAUX ===" -ForegroundColor Green
Write-Host "Job Spark qui analyse HDFS pour détecter les records climatiques" -ForegroundColor Cyan
...
Write-Host "`n=== EXERCICE 10 TERMINE ===" -ForegroundColor Green
